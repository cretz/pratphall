...
declare function proc_get_status(process: Pct.PhpResource): PhpAssocArray;
declare function proc_nice(increment: number): bool;
declare function proc_open(cmd: string, descriptorspec: Array, $pipes: number[], cwd?: string, env?: PhpAssocArray, other_options?: PhpAssocArray): Pct.PhpResource;
